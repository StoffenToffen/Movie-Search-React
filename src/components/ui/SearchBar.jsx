	...
	return (
		<div className="relative mt-10 mb-15">
			<input
				...
				className="bg-none text-xl border-2 border-secondary rounded-full outline-none w-64 py-4 px-8 transition duration-300 focus:shadow-[0_0_8px] focus:shadow-accent focus:scale-102 xs:w-full xs:py-6 xs:pr-16 xs:pl-8"
			/>
			<Search
				size={30}
